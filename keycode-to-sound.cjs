...
const keyDefinitions = [
  ...
  //Letters
  { keycodes: [65, 0, null], key: 'a', sound: '&.voice.a' },
  { keycodes: [66, 11, null], key: 'b', sound: '&.voice.b' },
  { keycodes: [67, 8, null], key: 'c', sound: '&.voice.c' },
  ...
  { keycodes: [83, 1, null], key: 's', sound: '&.voice.s' },
  { keycodes: [84, 17, null], key: 't', sound: '&.voice.t' },
  { keycodes: [85, 32, null], key: 'u', sound: '&.voice.u' },
  { keycodes: [86, 9, null], key: 'v', sound: '&.voice.v' },
  { keycodes: [87, 13, null], key: 'w', sound: '&.voice.w' },
  { keycodes: [88, 7, null], key: 'x', sound: '&.voice.x' },
  { keycodes: [89, 16, null], key: 'y', sound: '&.voice.y' },
  { keycodes: [90, 6, null], key: 'z', sound: '&.voice.z' },
  // Function Keys
